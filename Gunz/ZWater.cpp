...
#define WATER_UPDATE_INTERVAL 30 // ÃÊ´ç ¾à 30ÇÁ·¹ÀÓ À¯Áö
...
bool ZWater::SetMesh( RMeshNode* meshNode )
{
	...
	// set Bounding Box..
	// ¹°°áÀÇ °íÀú°¡ WAVE_PITCH ¸¦ ³ÑÁö ¾Ê´Â´Ù´Â °¡Á¤..
	...
	if(pMtrlMgr != NULL ) 
	{
		...
		if(m_pTexture == NULL)
		{
			...
			mlog("No texture, Substitution default texture!");//mlog("ÅØ½ºÃÄ°¡ ¾øÀ¸¸é µðÆúÆ® ÅØ½ºÃÄ·Î ´ëÃ¼");
		}
	...
	if (FAILED(g_pDevice->CreateIndexBuffer(m_nFaces * 3 * sizeof(WORD), D3DUSAGE_WRITEONLY, D3DFMT_INDEX16, g_isDirect3D9ExEnabled ? D3DPOOL_DEFAULT : D3DPOOL_MANAGED, &m_pIndexBuffer, NULL)))
	{
...
//	g_pDevice->SetRenderState( D3DRS_DESTBLEND, D3DBLEND_ONE);
	...
	g_pDevice->DrawIndexedPrimitive( D3DPT_TRIANGLELIST,0, 0, m_nVerts, 0, m_nFaces);
 	...
 	// under water ... ±×¸®±â ÈñÃ¶¾¾°¡ º° ÇÊ¿ä ¾ø´Ù°í ÇÔ..
/*
