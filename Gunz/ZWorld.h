...
public:
	...
	bool CheckWallHang(rvector const& pos, rvector const& dir, bool const& initial);
	bool CheckStandingOnObject(rvector& pos);
	bool GetFloor(rvector& origin, float fRadius, float fHeight, rplane* pimpactplane);
