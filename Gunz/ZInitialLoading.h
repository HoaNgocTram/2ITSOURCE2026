...
public:
	...
	void DrawIntro(const char* szFileName, int nTimeMS);
	...
	void	SetLoadingStr(string strParam) { m_strLoadingStr = strParam; }
...
public:
	ZLoadingProgress(string strName,ZLoadingProgress *pParent=NULL,float fRatio=1.f);
