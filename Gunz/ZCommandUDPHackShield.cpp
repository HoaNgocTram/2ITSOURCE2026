...
#ifdef _SPMOTIONLAST
	AddDeniedCommand(MC_MATCH_SPMOTION_REPLY);
#endif
...
#ifdef _PLAYERINO
	AddDeniedCommand(MC_MATCH_INFORMATION);
	AddDeniedCommand(MC_MATCH_INFORMATION_RECEIVE);
	AddDeniedCommand(MC_MATCH_INFORMATION_HPAP);
	AddDeniedCommand(MC_MATCH_INFORMATION_HPAP_GO);
	AddDeniedCommand(MC_MATCH_INFORMATION_CLOTHES);
	AddDeniedCommand(MC_MATCH_INFORMATION_CLOTHES_GO);
#endif
