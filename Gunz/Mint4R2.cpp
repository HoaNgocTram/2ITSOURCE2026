...
//		dwColor = 0xffffffff;
//
//	// ----- UTF-8 → UTF-16 (không copy NULL) -----
//	int len = (int)strlen(szText);
//	int wlen = MultiByteToWideChar(CP_UTF8, 0, szText, len, NULL, 0);
//	if (wlen <= 0)
//		return 0;
//
//	std::wstring wtext;
//	wtext.resize(wlen);
//
//	MultiByteToWideChar(CP_UTF8, 0, szText, len, &wtext[0], wlen);
//
//	// ----- DrawText với length chuẩn -----
//	WStringView view(wtext.c_str(), wlen);
//	pFont->m_Font.DrawText((float)x, (float)y, view, dwColor, pFont->m_fScale);
//
//	return 0;
//}
