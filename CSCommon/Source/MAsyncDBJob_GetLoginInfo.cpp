...
void MAsyncDBJob_GetLoginInfo::Run(void* pContext)
{
	...
	if (!pDBMgr->GetLoginInfo(m_szUserID, &m_nAID, m_szDBPassword/*, m_szSalt*/))
	{
		// Custom: GunZ SQL Exploit fix
		/*
		...
		pDBMgr->GetLoginInfo(m_szUserID, &m_nAID, m_szDBPassword, m_szSalt);
		*/
