...
#ifdef _PLAYERINO
	C(MC_MATCH_INFORMATION, "Lobby.Information", "Information Lobby Frame", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "strTarget")
	C(MC_MATCH_INFORMATION_RECEIVE, "Lobby.Information.Receive", "Information Lobby Frame", MCDT_MACHINE2MACHINE)
		P(MPT_BLOB, "InformationFrame")

	C(MC_MATCH_INFORMATION_HPAP, "Lobby.Information.Receive", "Information Lobby Frame", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "strTarget")
	C(MC_MATCH_INFORMATION_HPAP_GO, "Lobby.Information.Receive", "Information Lobby Frame", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "strTarget")
		P(MPT_INT, "HP")
		P(MPT_INT, "AP")

	C(MC_MATCH_INFORMATION_CLOTHES, "Lobby.Information.Receive", "Information Lobby Frame", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "strTarget")
	C(MC_MATCH_INFORMATION_CLOTHES_GO, "Lobby.Information.Receive", "Information Lobby Frame", MCDT_MACHINE2MACHINE)
		P(MPT_STR, "strTarget")
		P(MPT_BLOB, "Items")
#endif
...
#ifdef _SPMOTIONLAST
	C(MC_MATCH_SPMOTION, "Match.ObjectSpMotion", "Object SpMotion", MCDT_MACHINE2MACHINE);
	C(MC_MATCH_SPMOTION_REPLY, "Match.ObjectSpMotion.Reply", "Object SpMotion Reply", MCDT_MACHINE2MACHINE);
		P(MPT_INT, "SelType");
		P(MPT_UID, "uid")
#endif
...
#endif
#ifdef _FLOATDMGTEXT
	C(MC_PEER_DAMAGECOUNTER, "Peer.DamageCounter", "Damage counter information", MCDT_PEER2PEER)
		P(MPT_FLOAT, "Damage");
		P(MPT_UID, "AttackerUID");
		P(MPT_UID, "VictimUID");
		P(MPT_BOOL, "isMultiple");
#endif
