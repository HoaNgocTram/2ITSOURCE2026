...
#ifdef _LOBBYSET
	float GetGravityValue()				{ return m_StageSetting.GetGravityValue(); }
	void SetGravityValue(float nValue)	{ m_StageSetting.SetGravityValue(nValue); }

	float GetJumpValue()				{ return m_StageSetting.GetJumpValue(); }
	void SetJumpValue(float nValue)	{ m_StageSetting.SetJumpValue(nValue); }

	float GetSpeedValue()	{ return m_StageSetting.GetSpeedValue(); }
	void SetSpeedValue(float nValue)	{ m_StageSetting.SetSpeedValue(nValue); }

	int	GetDMGType()			{ return m_StageSetting.GetDMGType(); }
	void SetDMGType(int nValue)			{ m_StageSetting.SetDMGType(nValue); }
#endif
